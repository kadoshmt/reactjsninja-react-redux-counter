...
export const Counters = ({ counters, addCounter, removeCounter, increment, decrement }) => (
  <div>
    ...
    <div style={{ display: 'flex', justifyContent: 'space-around', marginTop: 40 }}>
      <button style={{ color: 'white', backgroundColor: 'green', border: 0, padding: 10 }} onClick={addCounter}>Adicionar Contador</button>
    </div>
  </div>
)
